...
```
This package aims to provide ready-to-use shapefiles for different administrative 
...
Division, District, Upazilla, Union). The easiest way to get the shapefile for
...
administrative levels of Bangladesh, which uses [`tmap`](https://cran.r-project.org/web/packages/tmap/), a very flexible and cool package to visualize thematic maps.
...
returns a `ggplot` object, when interactive (view) it returns a [`leaflet`](https://cran.r-project.org/web/packages/leaflet) object. 
